...
import static io.ballerina.compiler.syntax.tree.SyntaxKind.METHOD_CALL;
...
public class HttpStaticCodeAnalyzer extends CodeAnalyzer {
    ...
    public void init(CodeAnalysisContext analysisContext) {
        ...
        analysisContext.addSyntaxNodeAnalysisTask(new HttpDeserializationAnalyzer(reporter), METHOD_CALL);
    }
}

...
public class StaticCodeAnalyzerTest {
    ...
    public void testStaticCodeRulesWithAPI() throws IOException {
        ...
        for (HttpRule rule : HttpRule.values()) {
            ...
            Assertions.assertIssue(issues, 0, "ballerina/http:1", "service_class.bal",
                    21, 21, Source.BUILT_IN);
            Assertions.assertIssue(issues, 0, "ballerina/http:1", "service_class.bal",
                    25, 25, Source.BUILT_IN);
            Assertions.assertIssue(issues, 0, "ballerina/http:1", "service_object.bal",
            ...
            Assertions.assertIssue(issues, 0, "ballerina/http:2", "service.bal",
                    27, 27, Source.BUILT_IN);
            Assertions.assertIssue(issues, 0, "ballerina/http:2", "service_class.bal",
                    23, 23, Source.BUILT_IN);
            ...
            Assertions.assertIssue(issues, 0, "ballerina/http:3", "service.bal",
                    27, 27, Source.BUILT_IN);
            Assertions.assertIssue(issues, 0, "ballerina/http:3", "service_class.bal",
                    21, 21, Source.BUILT_IN);
            Assertions.assertIssue(issues, 0, "ballerina/http:3", "service_class.bal",
                    27, 27, Source.BUILT_IN);
